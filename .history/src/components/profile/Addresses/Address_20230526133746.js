    ...
    <div key={index} className="border border-gray-100 flex items-center justify-between">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 justify-between px-4">
        <div className="flex gap-3">
          ...
          <button onClick={handleRemove} class="text-white border border-rose-700 hover:border-rose-800  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 ">

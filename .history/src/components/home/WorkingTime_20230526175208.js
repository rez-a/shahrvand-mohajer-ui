...
const WorkingTime = () => {
  ...
  return (
    ...
    >
      ...
      className="text-neutral-800 hover:text-white border border-nutext-neutral-800 hover:bg-nutext-neutral-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">

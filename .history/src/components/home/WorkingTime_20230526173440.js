...
const WorkingTime = () => {
  ...
  return (
    ...
    >
      ...
      <button disabled type="button" class="py-2.5 px-5 mr-2 text-sm font-medium text-gray-900 bg-black/40 rounded-lg border border-black/30 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 inline-flex items-center">

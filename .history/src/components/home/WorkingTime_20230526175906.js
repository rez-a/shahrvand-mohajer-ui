...
const WorkingTime = () => {
  ...
  return (
    ...
    >
      ...
      className="hover:text-neutral-800 text-white border border-neutral-800 hover:bg-neutral-800 focus:ring-4 focus:outline-none focus:ring-neutral-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">

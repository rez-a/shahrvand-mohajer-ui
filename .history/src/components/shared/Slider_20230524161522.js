...
const Slider = ({ products, title, linkTo, isPagination }) => {
  ...
  return (
    <>
        ...
        <h2 className="font-semibold text-neutral-800 flex items-center px-4 py-5">
          ...
          >
            <path
              stroke="#323232"
              stroke-width="1.512"
              d="M15.015 3.74a2.268 2.268 0 1 1-3.208 3.207 2.268 2.268 0 0 1 3.208-3.208m5.247 6.556a2.722 2.722 0 1 1-3.85 3.85 2.722 2.722 0 0 1 3.85-3.85M6.563 15.35a1.36 1.36 0 1 1-1.924 1.924 1.36 1.36 0 0 1 1.924-1.924m.434-8.262a1.815 1.815 0 1 1-2.566 2.567 1.815 1.815 0 0 1 2.566-2.567"
            />
            <path
              stroke="#323232"
              ...
              stroke-width="1.5"
              d="M11.995 20.167a.453.453 0 1 0 .002.906.453.453 0 0 0-.002-.906"
            />
          </svg>
      ...
      <main className="border-t border-gray-400 flex">
        <Swiper
        ...
        >
          ...
          <SwiperNavBtn
            nextButtonClassName="right-0 left-auto top-0 pr-2 absolute bg-white border-l z-10 w-10 h-full hover:bg-gray-50"
            nextIcon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            prevButtonClassName="left-0 right-auto top-0 pr-2 absolute bg-white border-r z-10 w-10 h-full hover:bg-gray-50"
            prevIcon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"

    ...
    <>
      ...
      <main className="pt-4 flex">
        ...
        >
          ...
          <SwiperNavBtn
            nextButtonClassName="right-0 left-auto top-0 absolute bg-white z-10 w-8 h-full hover:bg-gray-50"
            nextIcon={
            ...
            prevButtonClassName="left-0 right-auto top-0 absolute bg-white z-10 w-8 h-full hover:bg-gray-50"
            prevIcon={
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">

  ...
  <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.995 20.167a.453.453 0 1 0 .002.906.453.453 0 0 0-.002-.906"/>
        ...
        {!!linkTo && (
          <div className="mr-auto">
            <Link
              to={linkTo}
              className="border border-gray-500 hover:bg-gray-100 transition-all duration-200 rounded-lg text-gray-700 font-bold px-4 py-2 relative before:absolute before:w-4 before:h-[1px] before:bg-zinc-300 before:-left-4 before:top-1/2 before:-translate-y-1/2"
              type="button"
            >
              مشاهده همه

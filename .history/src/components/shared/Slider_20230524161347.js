    ...
    <>
      ...
      <main className="pt-4 flex">
        ...
        >
          ...
          <SwiperNavBtn
            nextButtonClassName="right-0 left-auto top-0 pr-2 absolute bg-white z-10 w-10 h-full hover:bg-gray-50"
            nextIcon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            prevButtonClassName="left-0 right-auto top-0 pr-2 absolute bg-white z-10 w-10 h-full hover:bg-gray-50"
            prevIcon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"

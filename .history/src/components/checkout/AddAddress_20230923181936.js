  ...
  return (
    <>
      <button
        ...
        className="h-9 border border-neutral-800 rounded-lg bg-sky-500 text-white flex items-center justify-evenly text-right font-light text-md text-neutral-800 px-4 mb-3"
      >
        <span>ایجاد آدرس جدید</span>
        <div className="w-[1px] bg-inherit inline-block h-[calc(100%-12px)] mx-2"></div>
        <svg

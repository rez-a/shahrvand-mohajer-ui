...
const Addresses = ({ user, orderAddress, order, setOrder, setEditAddress }) => {
        ...
        {!editAddress ? (
          <div className="border-r-2 border-r-rose-500 pr-2">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
              <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-4 sm:gap-8 mb-6 md:mb-2">
                <p className="text-zinc-500">
                  گیرنده :
                  <span className="text-black font-semibold mr-1">{name}</span>
                </p>
              </div>
              <button
            ...
            <p className="text-zinc-500 my-3 text-sm">
              شماره تماس :
              <span className="text-black font-semibold mr-1">{mobile}</span>
            </p>

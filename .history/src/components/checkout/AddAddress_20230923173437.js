  ...
  return (
    <>
      <button
        ...
        className="border rounded-lg flex items-center text-right font-light text-md text-neutral-600 px-4 py-3 mb-3"
      >
        <span>ایجاد آدرس جدید</span>
        <span className="w-[1px] bg-black inline-block h-[calc(100%-8px)] h-full"></span>
        <svg

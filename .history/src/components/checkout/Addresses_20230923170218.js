          ...
          <div className="pr-2">
            ...
            <div className="flex items-center justify-end">
              <button
                ...
                className="hover:opacity-70 relative overflow-hidden group block text-sky-800 w-auto text-sm px-4 py-2 rounded-md font-right transition-all duration-300"
              >

          ...
          <div className="border-r-2 border-r-rose-500 pr-2">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
              ...
              <button
                ...
                className="relative overflow-hidden group block text-white w-auto text-sm px-4 py-2 rounded-md font-bold shadow-lg  transition-all duration-300 bg-blue-500  hover:bg-blue-500 bg-blue-500/90 "
              >
                تغییر آدرس ارسال
              </button>
            </div>

  ...
  return (
    <>
      <button
        ...
        className="border rounded-lg   text-right font-light text-md text-neutral-600 px-4 py-3 mb-3"
      >
        <span>ایجاد آدرس جدید</span>
        <div className="w-2 bg-slate-900 border inline-block h-[100%] mx-1"></div>
        <svg

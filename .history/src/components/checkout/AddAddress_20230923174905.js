  ...
  return (
    <>
      <button
        ...
        className="h-9 border border-neutral-800 rounded-lg flex items-center  text-right font-light text-md text-neutral-800 px-4 py-3 mb-3"
      >
        <span>ایجاد آدرس جدید</span>
        <div className="w-[1px] bg-black inline-block h-[calc(100%-8px)] h-full mx-1">
          1
        </div>

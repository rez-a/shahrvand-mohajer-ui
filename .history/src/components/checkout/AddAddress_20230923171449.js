  ...
  return (
    <>
      <button
        ...
        className="border rounded-lg border-neutral-500 flex gap-4 text-right font-semibold text-md text-neutral-600 py-4 mb-3"
      >
        <span>ایجاد آدرس جدید</span>
        <span className="w-[1px] bg-black block max-h-[100%-8px] h-full"></span>
        <svg

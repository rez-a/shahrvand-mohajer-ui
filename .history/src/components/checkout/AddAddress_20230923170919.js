...
const AddAddress = ({ addresses, handleUpdateAddresses }) => {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.997 14.001a4.002 4.002 0 1 1 0 8.003 4.002 4.002 0 0 1 0-8.003m-1.178 4.002h2.357m-1.179 1.178v-2.357"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.757 14.01a8.504 8.504 0 1 1 4.232 4.232"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m14.455 14.601 2.501-6.759a.619.619 0 0 0-.795-.795L9.399 9.551a.618.618 0 0 0 .064 1.18l3.046.766.76 3.036a.62.62 0 0 0 1.186.068v0Z" clip-rule="evenodd"/>
</svg>

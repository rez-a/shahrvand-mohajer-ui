      ...
      <div class="flex flex-col justify-between leading-normal w-full grow lg:mr-2 text-xs lg:text-base">
        ...
        <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
          <div className="flex items-center mt-2 mb-4 w-full sm:justify-center lg:w-2/3 lg:justify-start">
			...
			<button class="block text-white text-sm shadow-border bg-green hover:bg-green-600 text-sm py-3 px-4 font-sans tracking-wide uppercase font-bold">
				schedule a demo
			</button>
			<div class="bg-red-600 shadow-border p-3">
				<button class="text-white">
        <svg xmlns="http://www.w3.org/2000/svg" className="fill-current w-4 h-4" fill="none" viewBox="0 0 24 24">

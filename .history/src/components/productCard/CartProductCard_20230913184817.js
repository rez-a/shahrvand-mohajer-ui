        ...
        <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
          <div className="flex items-center mt-2 mb-4 w-full sm:justify-center lg:w-2/3 lg:justify-start">
            ...
            >
              ...
              <div class="flex">
                <button class="bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-r-lg text-white p-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  class="bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium  rounded-l-lg text-white p-3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-xs font-semibold pr-1">حذفش کن</span>
                </button>
              </div>
            </button>
          </div>

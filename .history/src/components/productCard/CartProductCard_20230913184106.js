            ...
            >
              ...
              <button class="text-white p-3 bg-red-600">
                ...
                <button
                  ...
                  class="block text-white shadow-border bg-green-500 hover:bg-green-600 text-sm py-3 px-4 tracking-wide uppercase font-bold"
                >
                  ...
                  <span className="text-xs font-semibold pr-2">حذفش کن</span>
                </button>

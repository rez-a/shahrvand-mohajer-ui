      ...
      <div class="flex flex-col justify-between leading-normal w-full grow lg:mr-2 text-xs lg:text-base">
        ...
        <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
          <div className="flex items-center mt-2 mb-4 w-full sm:justify-center lg:w-2/3 lg:justify-start">
            ...
            <button
              className={`transition-all duration-500 ease-out ${showConfirmation ? "max-h-0 invisible" : "lg:block"}`}
            ...
            <div className={`transition-all duration-500 ease-out ${showConfirmation ? "h-full" : "max-h-0 invisible"}`}>
              <button

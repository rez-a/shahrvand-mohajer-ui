        ...
        <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
          <div className="flex items-center mt-2 mb-4 w-full sm:justify-center lg:w-2/3 lg:justify-start">
            ...
            >
              ...
              <div class="flex">
                <button class="bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-r-md text-white p-2 border-l-2 border-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  class="bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium  rounded-l-md text-white p-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-xs font-semibold px-1">حذفش کن</span>
                </button>
              </div>
            </button>
          </div>

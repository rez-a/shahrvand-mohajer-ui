    ...
    <div className="absolute border border-gray-200 bg-white sm:w-72 w-40 left-0 top-full rounded-lg text-sm mt-1 shadow-lg">
      <ul className="" onClick={() => setShowProfileLinks(false)}>
        <li>
          ...
          >
            <div className="flex items-center ml-1 px-4 py-3 after:border-gray-300 after:border-b after:w-8 after:h-2 after:inline-flex ">
              <span class="relative flex h-3 w-3">
                <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-sky-400 opacity-75"></span>
                <span class="relative inline-flex rounded-full h-3 w-3 bg-sky-500"></span>
              </span>
            </div>
            <div className=" border-gray-100 pr-2 font-bold px-4 py-3 w-full">
              <span>کیف پول</span>
            </div>

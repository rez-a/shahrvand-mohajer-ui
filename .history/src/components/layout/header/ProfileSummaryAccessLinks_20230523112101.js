      ...
      >
        <li>
          ...
          >
            ...
            <div className="pr-2 border">کیف پول</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.002 21.004H6.998a4.002 4.002 0 0 1-4.002-4.002V6.998a4.002 4.002 0 0 1 4.002-4.002h10.004a4.002 4.002 0 0 1 4.002 4.002v10.004a4.002 4.002 0 0 1-4.002 4.002Z" clip-rule="evenodd"/>
            ...
            <div className="pr-2 border">پروفایل</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2 border">ویرایش اطلاعات</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2 border">آدرس ها</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2 border">سفارش ها</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2 border">پرداخت ها</div>
          </Link>
        </li>
        <li>
          <button
          ...
          >
            ...
            <div className="pr-2 border">خروج از حساب کاربری</div>
          </button>
        </li>
      </ul>
    </div>

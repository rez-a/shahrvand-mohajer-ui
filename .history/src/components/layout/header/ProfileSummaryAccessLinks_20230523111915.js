    ...
    <div className="absolute border border-gray-200 bg-white sm:w-72 w-40 left-0 top-full rounded-lg text-sm mt-1 shadow-lg">
      ...
      >
        <li>
          <Link
            to="/profile/wallet"
            className="flex items-center text-neutral-800 font-medium hover:bg-gray-50 overflow-hidden"
          >
            <div className="ml-1 p-4 bg-gray-50 border-l border-gray-100">
              <svg
                version="1.1"
                id="Layer_1"
            ...
            <div className="pr-2">کیف پول</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.592 7.657a2.25 2.25 0 1 1-3.182 3.184 2.25 2.25 0 0 1 3.182-3.184m2.731 8.886a2.906 2.906 0 0 0-2.866-2.454h-2.914a2.905 2.905 0 0 0-2.866 2.454"/>
  <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.002 21.004H6.998a4.002 4.002 0 0 1-4.002-4.002V6.998a4.002 4.002 0 0 1 4.002-4.002h10.004a4.002 4.002 0 0 1 4.002 4.002v10.004a4.002 4.002 0 0 1-4.002 4.002Z" clip-rule="evenodd"/>
</svg>
        ...
        <li>
          ...
          >
            ...
            <div className="pr-2">ویرایش اطلاعات</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2">آدرس ها</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2">سفارش ها</div>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <div className="pr-2">پرداخت ها</div>
          </Link>
        </li>
        <li>
          <button
          ...
          >
            ...
            <div className="pr-2">خروج از حساب کاربری</div>
          </button>
        </li>
      </ul>
    </div>

...
const Profile = () => {
  ...
  return (
    <main className="grid grid-cols-1 xl:grid-cols-7 gap-4 items-start mt-4 mx-4 2xl:mx-0">
      {user && (
        <>
          <aside className=" bg-gray-50/50 xl:col-span-2 border-gray-200/70 overflow-hidden xl:sticky top-32 bg-white rounded-3xl shadow-sm border order-2 xl:order-1">
            <ul>
              <li>
                <NavLink
                  to="/profile/wallet"

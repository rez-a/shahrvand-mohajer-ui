                ...
                <div className="flex flex-col lg:flex-row items-start justify-between my-4">
                  <div>
                    ...
                    <div className="flex items-center max-w-[20rem] mx-auto my-2">
                      <svg xmlns="http://www.w3.org/2000/svg" className="fill-rose-500" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.7 4C18.87 4 21 6.98 21 9.76 21 15.39 12.16 20 12 20c-.16 0-9-4.61-9-10.24C3 6.98 5.13 4 8.3 4c1.82 0 3.01.91 3.7 1.71.69-.8 1.88-1.71 3.7-1.71Z" clip-rule="evenodd"/>
</svg>

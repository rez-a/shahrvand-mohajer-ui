...
const AboutUs = () => {
  return (
    <>
      <Breadcrumb links={[{ title: 'درباره ما' }]} />
        ...
        <section className=" bg-white p-4 py-8 rounded-md border border-gray-100">
          <article className="mb-12">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-rose-500 font-bold mr-2">
                هایپر مارکت آنلاین شهروند ، بررسی، انتخاب و خرید
                آنلاین.
              </h2>
            </div>
            <p className="text-sm text-gray-700 leading-8">
              یک خرید اینترنتی مطمئن، نیازمند فروشگاهی است که بتواند
              کالاهایی متنوع، باکیفیت و دارای قیمت مناسب را در مدت
              زمانی کوتاه به دست مشتریان خود برساند و ضمانت بازگشت
              کالا هم داشته باشد؛ ویژگی‌هایی که فروشگاه اینترنتی
              شهروند سال‌هاست بر روی آن‌ها کار کرده و توانسته از این
          ...
          <article className="mb-12">
            <div className="flex items-center mb-4">
              <TitleIcon bg="bg-rose-500 " />
              <h2 className="text-rose-500 font-bold mr-2">
                کدام محصولات در شهروند قابل سفارش هستند؟
              </h2>
            </div>
            <p className="text-sm text-gray-700 leading-8">
              تقریبا می‌توان گفت محصولی وجود ندارد که شهروند برای
              مشتریان خود در شهر مهاجران فراهم نکرده باشد. شما
              می‌توانید در تمامی روزهای هفته و تمامی شبانه روز یا در
              روزهای خاصی مثل حراج شگفت انگیز شهروند که محصولات دارای
              تخفیف عالی می‌شوند، سفارش خود را به سادگی ثبت کرده و در
              روز و محدوده زمانی مناسب خود، درب منزل تحویل بگیرید.
              بعضی از گروه‌های اصلی و زیر مجموعه‌های پرطرفدار محصولات
              شهروند شامل مواردی می‌شود که در ادامه به معرفی آن‌ها
              می‌پردازیم.
            </p>
          </article>
          <article className="mb-12">
            ...
            <p className="text-sm text-gray-700 leading-8">
              ...
              شهروند پیدا می‌شود، محصولات پرطرفداری مثل کره
              بادام‌زمینی، عسل، سس، قهوه، زعفران، شکلات، انواع نان و
              ... از برندهای معتبر و معروفی مثل نستله، نوتلا،
              استارباکس، مزمز، چی توز و ... همگی در اختیار شما هستند و
          ...
          <article className="mb-12">
            ...
            <p className="text-sm text-gray-700 leading-8">
              بخش هنر، کتاب، رمان و لوازم تحریر شهروند نیز یکی از
              متنوع‌ترین بخش‌های این فروشگاه اینترنتی است. انواع کتاب
              و مجله، بازی و لوازم تحریر با بهترین قیمت‌ها و از بهترین

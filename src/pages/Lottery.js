...
const Lottery = () => {
      ...
      return (
        <>
          <p className="flex justify-center gap-4">
            <span className="text-sky-700 bg-sky-100 w-16 h-14 text-3xl flex items-center justify-center rounded-md">
          ...
          <p className="text-sm text-rose-500 py-4 text-center">
            <p className="mb-2">مانده تا قرعه کشی</p>
            <span className="text-base font-bold">کس خر</span>
          </p>
        </>
      );
    }
  ...
  return (
    <>
      <Breadcrumb links={[{ title: 'قرعه کشی ها' }]} />
      <main className="grid grid-cols-1 xl:grid-cols-7 gap-4 items-start mt-4 mx-4 2xl:mx-0">
        <aside className="bg-gray-50/50 xl:col-span-2 border-gray-200/70 overflow-hidden xl:sticky top-32 bg-white rounded-md shadow-sm border">
          <svg
            version="1.1"
            id="Layer_1"
	...
	212.57,135.73 218.89,135.73 "
        ...
        <section className="grid xl:col-span-5 gap-y-4 rounded-md bg-gray-50/50 border border-gray-200/70 bg-white xl:sticky top-32">
          <div className="flex items-center p-4 mb-4">
            <TitleIcon />
            <h2 className="text-zinc-500 font-bold mr-2">
              لیست قرعه کشی ها
            </h2>
          </div>
          <div className="grid grid-cols-3 gap-3 gap-y-16 p-4">
            {[...Array(4)].map((lottery) => (
              <LotteryCard />
            ))}
          </div>

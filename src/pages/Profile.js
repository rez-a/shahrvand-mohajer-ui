        ...
        <ul>
          <li>
            <NavLink
              ...
              className={(navData) =>
                navData.isActive
                  ? 'bg-sky-50 text-sky-500 border-b border-b-sky-400'
                  : 'hover:bg-sky-50 hover:text-sky-500 border-b border-b-gray-100 hover:border-b-sky-400 group transition-all duration-300 text-slate-700'
              }
            ...
            >
              <span className="ml-3">
                <svg
                  ...
                  width="24"
                  height="24"
                  className="fill-current group-hover:fill-current"
                >

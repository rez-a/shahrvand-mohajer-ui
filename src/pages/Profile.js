...
const Profile = (props) => {
  return (
    <main className="grid grid-cols-7 gap-4 items-start">
      <aside className=" bg-gray-50/50 col-span-2 rounded-md overflow-hidden sticky top-4 mb-14">
        <ul>
          <li>
            <a
              href="#"
              className="flex items-center w-full p-3 bg-sky-50/50 text-sky-400 border-b border-b-sky-200"
            >
              <span className="ml-1">
                <svg
          ...
          <li>
            <a
              href="#"
              className=" flex items-center w-full p-3 hover:bg-sky-50/50 hover:text-sky-400 border-b border-b-gray-100 hover:border-b-sky-200 group transition-all duration-300"
            >
              <span className="ml-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  width="20"
                  height="20"
                  className="fill-zinc-400 group-hover:fill-sky-400"
                >
      ...
      <main className="col-span-5 mb-4">
        <Outlet />
      </main>
    </main>
  );

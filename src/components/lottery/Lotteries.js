...
import LotteryCardLoading from './LotteryCardLoading';

const Lotteries = ({ setLottery }) => {
            ...
            {!!data ? (
              !!lotteries.length ? (
                ...
                <div className="bg-gray-200 border rounded-xl flex flex-col items-center justify-center py-4">
                  ...
                  <p className="font-bold text-rose-600 text-xl relative -top-4">
                    هیچ جشنواره قبلی وجود ندارد
                  </p>
                </div>
              )
            ) : (

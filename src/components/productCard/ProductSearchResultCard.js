  ...
  return (
    <div class={`flex flex-col relative hover:bg-slate-50`}>
      <div className="flex items-center rounded-md p-2">
        ...
        <div class="pr-2 w-3/4  flex flex-col justify-between leading-normal grow">
          <div class="text-gray-900 w-5/6 truncate whitespace-nowrap hover:text-rose-500 transition-all duration-200 mb-2">
            <Highlighter

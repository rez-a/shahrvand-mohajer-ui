        ...
        <ul className="">
          <li>
            <Link
              to="/profile/wallet"
              className={
                'hover:bg-gray-100 text-sm flex items-center group transition-all duration-300 text-[#1a2947]'
              }
            >
              <span className=" ml-3 rounded-md  py-1.5 group-[.is-published]:bg-rose-500 transition-all duration-200">
                <svg
                  version="1.1"
                  id="Layer_1"
                  xmlns="http://www.w3.org/2000/svg"
